...
__C.DATASET.IN_CHANNELS = 3

# Model options
__C.MODEL = edict()
__C.MODEL.FEATURE_EXTRACTOR = 'fcn'
...
__C.DATA_TRANSFORM.RESIZE_OR_CROP = None #'resize_and_crop'
__C.DATA_TRANSFORM.LOADSIZE = None #256
__C.DATA_TRANSFORM.FINESIZE = None #224
__C.DATA_TRANSFORM.FLIP = False #True
__C.DATA_TRANSFORM.WITH_FIVE_CROP = False
__C.DATA_TRANSFORM.NORMALIZE_MEAN = None #(0.485, 0.456, 0.406)
__C.DATA_TRANSFORM.NORMALIZE_STD = None #(0.229, 0.224, 0.225)
...
__C.CLUSTERING.MAX_ITERATIONS = 20000  # otherwise on some datasets it's an infinite loop, never is < EPS
